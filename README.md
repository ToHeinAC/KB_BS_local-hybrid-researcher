...
- **Persistent Results View**: Completed report page shows HITL conversation, task summaries with findings/gaps, and per-chunk expanders with full original vector DB text + LLM extraction alongside the final answer.
